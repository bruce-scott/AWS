...
mysql -h call-mysql-db-server.cbanmzptkrzf.us-east-1.rds.amazonaws.com -u hr_guy -pHr_guy1234 clarusway
...
mysql -h restored-from-time-call-mysqld-db-s
erver.cbanmzptkrzf.us-east-1.rds.amazonaws.com -u hr_guy -p clarusway
